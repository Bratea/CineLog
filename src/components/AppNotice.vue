...
.app-notice--library,.app-notice--home{top:72px;right:20px;width:210px}.app-notice--record{top:76px;right:58px;width:min(230px,calc(100% - 76px))}.app-notice--settings{top:72px;right:18px;width:210px}.app-notice--detail{top:82px;right:18px;width:230px;color:#fff;background:rgba(18,23,24,.9);border-color:color-mix(in srgb,var(--notice-color) 45%,rgba(255,255,255,.15));box-shadow:0 18px 38px rgba(0,0,0,.32)}
