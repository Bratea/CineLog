...
.detail-backdrop{position:absolute;inset:0 auto auto 0;width:100%;height:calc(54% + var(--scroll) * 46%);background-size:cover;background-position:center 20%;opacity:1;transform:scale(calc(1.035 + var(--scroll) * .018)) translateY(calc(var(--scroll) * -5px));transform-origin:50% 0;transition:height .12s linear,transform .12s linear;animation:backdrop-open .72s cubic-bezier(.18,.88,.2,1) both}.detail-backdrop::after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,transparent 0 calc(42% + var(--scroll) * 17%),rgba(7,16,15,.18) calc(59% + var(--scroll) * 15%),rgba(7,16,15,.86) calc(84% + var(--scroll) * 10%),var(--screen) 100%)}
