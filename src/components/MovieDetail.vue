...
.movie-detail { --accent:#f2b85b; --screen:#07100f; --swipe-x:0px; position:absolute; z-index:12; inset:0; overflow:hidden; color:#f7f1e8; background:var(--screen); touch-action:pan-y; translate:var(--swipe-x) 0; transform-origin:50% 72%; will-change:translate,transform,clip-path; }
...
.movie-detail.motion-medium :is(.detail-backdrop,.detail-cover-card,.detail-hero-copy h1,.release-chip,.detail-original,.detail-meta){animation:none}
.movie-detail.motion-low :is(.detail-backdrop,.detail-hero-copy,.detail-cover-card,.detail-hero-copy h1,.release-chip,.detail-original,.detail-meta,.still-main){animation:none}
