...
.detail-backdrop{position:absolute;inset:0;height:100%;background-size:cover;background-position:center 20%;opacity:1;transform:scale(calc(1.035 + var(--scroll) * .028)) translateY(calc(var(--scroll) * -7px));transition:transform .12s linear;animation:backdrop-open .72s cubic-bezier(.18,.88,.2,1) both}.detail-backdrop::after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,transparent 0 calc(38% + var(--scroll) * 20%),rgba(7,16,15,.16) calc(53% + var(--scroll) * 19%),rgba(7,16,15,.82) calc(76% + var(--scroll) * 16%),var(--screen) 100%);transition:background .12s linear}
...
.detail-dock{position:absolute;z-index:6;right:12px;bottom:16px;left:12px;display:grid;grid-template-columns:1fr 58px 1fr;align-items:center;height:56px;padding:5px 7px;border:1px solid rgba(255,255,255,.13);border-radius:21px;background:rgba(14,20,20,.82);box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 13px 27px rgba(0,0,0,.32);backdrop-filter:blur(22px) saturate(1.3);pointer-events:none}.detail-dock button{pointer-events:auto}.dock-empty{height:1px}.edit-dock{display:grid;place-items:center;width:58px;height:58px;padding:0;color:#171a19;border:1px solid rgba(255,255,255,.7);border-radius:50%;background:var(--accent);box-shadow:0 9px 24px color-mix(in srgb,var(--accent) 34%,rgba(0,0,0,.38)),inset 0 1px 0 rgba(255,255,255,.72);transform:translateY(-13px);transition:transform .24s cubic-bezier(.16,1,.3,1),box-shadow .24s}.edit-dock:active{transform:translateY(-10px) scale(.91)}.watch-toggle{display:flex;align-items:center;justify-content:center;justify-self:end;gap:5px;width:106px;height:42px;padding:0;color:rgba(255,255,255,.65);border:1px solid rgba(255,255,255,.13);border-radius:15px;background:rgba(255,255,255,.055);font-size:9px;font-weight:750;transition:color .25s,background .3s,border-color .3s,transform .2s}.watch-toggle.watched{color:#fff6e9;border-color:color-mix(in srgb,var(--accent) 44%,rgba(255,255,255,.12));background:linear-gradient(145deg,color-mix(in srgb,var(--accent) 38%,rgba(255,255,255,.08)),color-mix(in srgb,var(--accent) 13%,rgba(255,255,255,.03)))}.watch-toggle:active{transform:scale(.93)}
