...
.movie-detail.motion-high { animation:detail-gravity-home .76s cubic-bezier(.16,1,.3,1) both; }
...
:global(.native-app) .tmdb-score-card,
:global(.native-app) .trailer-card,
:global(.native-app) .quick-facts,
:global(.native-app) .detail-panel,
:global(.native-app) .release-chip,
:global(.native-app) .watch-island,
:global(.native-app) .record-editor-backdrop {
...
:global(.native-app) .trailer-card,
:global(.native-app) .quick-facts,
:global(.native-app) .detail-panel { transition:color .24s ease,background .24s ease,border-color .24s ease,box-shadow .24s ease; }
:global(.native-app) :is(.detail-backdrop,.detail-topbar,.detail-scroll) { will-change:auto; }
:global(.native-app) .movie-detail:is(.is-swipe-dragging,.has-swipe-transition) :is(.detail-backdrop,.detail-topbar,.detail-scroll) { will-change:translate,opacity; }
